...
class ChangePassView(Tk):
    ...
    def __init__(self, login):
        ...
        # Ввод нового пароля
        self.New_Password_Lable = ttk.Label(self, text="Ввод Старый Пароль", foreground="#ff3366")
        ...
        self.Conf_New_Password_Lable = ttk.Label(self, text="Ввод Старый Пароль", foreground="#ff3366")
